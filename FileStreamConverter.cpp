...
map<string, string> FileStreamConverter::GetMapFromFileDirectory(const char* fileDirectory)
{
	string cityName;
...
string FileStreamConverter::FindCityNameFromMap(map<string, string> onkzMapList, string areaCode)
{
	string cityName;
...
map<string, string> FileStreamConverter::LoadCCMap()
{
	const char* path;
...
map<string, string> FileStreamConverter::LoadACMapFromCC(string countryCode)
{
	const char* path;
